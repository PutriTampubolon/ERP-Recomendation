            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">Create ERP</h6>
                    ...
                    <!-- Card Body -->
                    <div class="card-body">
                        <form action="/erp/store" method="post" enctype="multipart/form-data" id="formTambahData">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-2">
                                            <input type="text"
                                                ...
                                                id="deployment" name="deployment" value="{{ old('deployment') }}">
                                            @error('deployment')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
