            ...
            <div class="col-xl-6 col-lg-6">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">Create Fungsionalitas</h6>
                    ...
                    <!-- Card Body -->
                    <div class="card-body">
                        <form action="/fungsionalitas/store" method="post" enctype="multipart/form-data" id="formTambahData">
                            @csrf
